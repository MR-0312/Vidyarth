...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="w-1/2 flex flex-col items-center justify-center p-8 bg-white rounded-r-3xl shadow-lg">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6">
            <span className="text-gray-500 text-sm">Or sign in using E-Mail Address</span>
          </div>
      ...
      <div className="w-1/2 bg-blue-500 flex flex-col items-center justify-center p-8 text-white">
        <div className="max-w-md text-center">
          ...
          <p className="mb-8 text-blue-100">Sign up if you still don't have an account ...</p>
          <Link
            to="/signup"
